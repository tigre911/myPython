...
data_clinic = pd.read_csv('../resources/선별진료소_20211109092929.csv', index_col=0, encoding='cp949', engine='python')
# data = pd.DataFrame(data[['시도', '시군구']])
print(data_clinic['시도'].unique())
print(data_clinic['시군구'].unique())
